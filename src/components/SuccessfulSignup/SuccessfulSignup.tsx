import { ButtonSubmit, TextForm, TitleForm } from "../UI";
...
const SuccessfulSignup: React.FC = () => {
  ...
  return(
    <form className={styles.successful} onSubmit={onClose}>
      ...
      <TextForm>Мы направили ссылку на Вашу почту, указанную при регистрации. Пожалуйста, подтвердите почту.</TextForm>
      <ButtonSubmit>Понятно!</ButtonSubmit>
    </form>
  );
}
